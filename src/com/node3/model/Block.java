package com.node3.model;

import java.util.Date;

import com.node3.util.SHA256;
import com.node3.util.StringUtil;
...
public class Block {
	...
	public void mineBlock(int difficulty) {
		...
		while(!hash.substring(0, difficulty).equals(target)) {
			...
			System.out.println("3번 노드의 Hash #"+ nonce+" : "+ hash);
			
		}
		System.out.println("3번 노드 채굴 성공!!! : " + hash);
	}
